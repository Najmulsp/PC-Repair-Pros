...
const Testimonial = () => {
  return (
    <div>
      <section className="bg-[#0F003E] border-2 border-red-600 dark:text-gray-800 flex flex-col lg:flex-row justify-center items-center">
        <div className="container max-w-6xl p-6  mx-auto ">
          <div className="border flex flex-col justify-center items-center lg:mt-8 w-full lg:col-span-3">
                ...
                >
                  <SwiperSlide>
                    <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
                      <div className="flex border rounded-lg flex-col max-w-sm mx-4 my-6 shadow-lg">
                        <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12">
                          ...
                          <p className="relative text-white px-6 py-1 text-lg  ">
                            I cant thank Stada enough for saving my computer!
                            Their team worked tirelessly to recover my files and
                            fix the software glitches. Fast, efficient, and
                    ...
                    <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
                      <div className="flex border rounded-lg flex-col max-w-sm mx-4 my-6 shadow-lg">
                        <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12">
                          ...
                          <p className="relative text-white px-6 py-1 text-lg italic text-center ">
