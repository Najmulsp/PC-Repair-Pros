    ...
    return (
      ...
      <div className="absolute inset-0 bg-gray-950 opacity-60"></div>{" "}
        ...
        <Image src={bannerLogo} alt="Service Image" width={330} height={30} className="absolute bottom-0 left-[35%] hidden lg:block" />
                            ...
                            {/* form */}
        <form onSubmit={handleUpdateBooking} className="w-3/5 my-10 p-10 bg-slate-700 mx-auto grid grid-cols-6 gap-4 col-span-full lg:col-span-3">

				<div className="col-span-full sm:col-span-3">
					<label htmlFor="service name" className="text-sm">Service Name</label>
					<input name="service" type="text" defaultValue={booking?.title}  className="w-full p-2 rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 text-black focus:dark:ring-violet-600 dark:border-gray-300" />
				</div>
				<div className="col-span-full sm:col-span-3">
					<label htmlFor="date" className="text-sm">Date</label>
					<input name="date" type="date" defaultValue={booking?.date}  className="w-full p-2 rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 text-black focus:dark:ring-violet-600 dark:border-gray-300" />
				</div>
				<div className="col-span-full sm:col-span-3">
					<label htmlFor="phone" className="text-sm">Phone</label>
					<input name="phone" type="number" defaultValue={booking?.phone} className="w-full p-2 rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 text-black focus:dark:ring-violet-600 dark:border-gray-300" />
				</div>
				<div className="col-span-full sm:col-span-3">
					<label htmlFor="address" className="text-sm">Address</label>
					<input name="address" type="text" defaultValue={booking?.address} className="w-full p-2 rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 text-black focus:dark:ring-violet-600 dark:border-gray-300" />
				</div>
				<div className="col-span-full">
					<label htmlFor="message" className="text-sm">Message</label>
					<textarea name="message" defaultValue={booking?.message} className="w-full p-2 rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 text-black focus:dark:ring-violet-600 dark:border-gray-300"></textarea>
				</div>  
