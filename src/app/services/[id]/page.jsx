...
const ServiceDetails = async({params}) => {
  ...
  return (
    <div className="container mx-auto mt-10 h-content">
      ...
      <Image src={banner1} alt="Service Image" width={1300} height={100} className="overflow-hidden opacity-50 object-contain" />
      ...
      <div className="my-10 mx-6  grid grid-cols-1 lg:grid-cols-3 gap-6 ">
        <div className="lg:col-span-2 col-span-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <div className="col-span-2 p-10 space-y-4 rounded-xl text-black bg-gradient-to-r from-[#FEF8F7] to-[#F6F7FF] border-t-4 border-blue-950 hover:border-orange-600 mt-4">
            ...
            <div className="col-span-2 p-10 space-y-4 rounded-xl text-black bg-gradient-to-r from-[#FEF8F7] to-[rgb(246,247,255)] border-t-4 border-blue-950 hover:border-orange-600 mt-4">
        ...
        <Link href={"#"}>
          ...
          <div className="bg-gradient-to-r from-[#FEF8F7] to-[#F6F7FF] rounded-xl">
